...
public class Estado {
	...
	public Estado(String state, String slug, String code, String nickname, String website, String admission_date,
			int admission_number, String capital_city, String capital_url, int population,
			int population_rank, String constitution_url, String state_flag_url, String state_seal_url,
			String map_image_url, String landscape_background_url, String skyline_background_url,
